...
echo   train.py -data data/nc_v11_nmt_amr/nmt_amr -save_model model/nmt_amr_2020 \
        -model_kind concat -layers 6 -rnn_size 512 -word_vec_size 512 -transformer_ff 2048 -heads 8  \
...
python3  train.py -data data/nc_v11_nmt_amr/nmt_amr -save_model model/nmt_amr_2020 \
        -model_kind concat -layers 6 -rnn_size 512 -word_vec_size 512 -transformer_ff 2048 -heads 8  \
        -encoder_type transformer -decoder_type transformer -position_encoding \
        -train_steps 300000  -max_generator_batches 100 -dropout 0.3 \
        -batch_size 4096 -batch_type tokens -normalization tokens  \
