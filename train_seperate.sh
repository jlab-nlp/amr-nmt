...
echo   train.py -data data/full_nmt_amr/nmt_amr -save_model model/full_seperate \
...
python3  train.py -data data/full_nmt_amr/nmt_amr -save_model model/full_seperate \
        -model_kind seperate -enc_layers 6 -dec_layers 6 -rnn_size 512 -word_vec_size 512 -transformer_ff 2048 -heads 8  \
        ...
        -world_size 1 --report_every 100 -gpu_ranks 0 \
        --share_decoder_embeddings --share_embeddings -aggregation jump \
        -log_file full_seperate.log -accum_count 2 -warmup_steps 16000 -learning_rate 2 -edges 5
        #-train_from model/amr2017/multiview_cat.bpe10.jump5.lr2.both/ADAM_step95000_lr0.00029.pt
