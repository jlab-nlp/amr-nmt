...
echo   train.py -data data/nc_v11_nmt_amr/nmt_amr -save_model model/nc_v11_nmt_amr_concat_single_decoder \
        -model_kind concat_single_decoder -layers 6 -rnn_size 512 -word_vec_size 512 -transformer_ff 2048 -heads 8  \
        ...
        -log_file nc_v11_nmt_amr_concat_single_decoder.log -accum_count 2 -warmup_steps 16000 -learning_rate 2 -edges 5
        #-train_from model/amr2017/multiview_cat.bpe10.jump5.lr2.both/ADAM_step95000_lr0.00029.pt

python3  train.py -data data/nc_v11_nmt_amr/nmt_amr -save_model model/nc_v11_nmt_amr_concat_single_decoder \
        -model_kind concat_single_decoder -layers 6 -rnn_size 512 -word_vec_size 512 -transformer_ff 2048 -heads 8  \
        -encoder_type transformer -decoder_type transformer -position_encoding \
        -train_steps 300000  -max_generator_batches 100 -dropout 0.3 \
        -batch_size 4096 -batch_type tokens -normalization tokens  \
