...
from onmt.inputters.barttext_dataset import BartTextDataReader
from onmt.inputters.datareader_base import DataReaderBase


str2reader = {
    "text": TextDataReader, "img": ImageDataReader,
    "vec": VecDataReader, 'grh': GrhDataReader, "bart_text": BartTextDataReader}
...
__all__ = ['Dataset', 'load_old_vocab', 'get_fields', 'DataReaderBase',
           ...
           'text_sort_key', 'img_sort_key',  'vec_sort_key',
           'TextDataReader', 'ImageDataReader',
           'VecDataReader', 'GrhDataReader']
# 'audio_sort_key', 'AudioDataReader'