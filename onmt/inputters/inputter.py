...
from onmt.inputters.barttext_dataset import barttext_fields
...
def get_fields(
    ...
    bart_text_field_kwargs = {"bart_config": bart_config,
                              "src_lang": src_lang,
                              "tgt_lang": tgt_lang,}
    fields["bart_text"] = fields_getters["bart_text"](**bart_text_field_kwargs)

    print(Field.__init__.__code__.co_varnames)
